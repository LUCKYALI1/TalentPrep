...
// 🚀 1. Static Grid Background Style (Preserves reference across renders)
...
// 🚀 2. Static Steps Data Array (Moved outside component to prevent memory re-allocation)
const STEPS = [
  {
    id: "01",
    tag: "STEP ONE",
...
// 🚀 3. Card Motion Variants (Extracted to lower GC overhead and optimize frame rates)
const cardVariants = {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 relative">
          {STEPS.map((step) => (
            ...
            >
              ...
              {/* Step Key Features Badges */}
              <div className="pt-4 border-t border-zinc-900 space-y-2 mt-auto">
                {step.features.map((feature) => (
                  <div key={feature} className="flex items-center gap-2 text-[11px] text-zinc-500 group-hover:text-zinc-400 font-mono transition-colors duration-200">
...
// 🚀 4. Wrapped export with React.memo to skip unnecessary re-renders
